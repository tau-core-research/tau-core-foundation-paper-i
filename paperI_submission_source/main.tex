...
are placeholders for branch-specific operational definitions, not yet
...
source-overlap ledger.  We call this residual cross-readout skeleton
invariance, abbreviated \(R\)-CRSI.  The name is only a discipline for
candidate support: it is not a validation statistic or an independence claim.
