...
\end{equation}
This difference has physical content only if independent readout constraints
exist beyond the spacetime block itself.  If no non-spacetime readout imposes
source-frozen restrictions, the distinction remains a metaphysical
rephrasing rather than a physical branch.
