...
The next foundation-stage milestone should be narrower than another general
framework layer.  A single worked branch is the appropriate target:
observer-time, finite readout-time, or another comparably small branch.  Such a
