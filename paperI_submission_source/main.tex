...
description works, but it does not take the block as ontologically final.  The
block is a sector output.
...
\begin{figure}[t]
  ...
  gravitational response, or mass/source structure.  The paper does not assume
  that these readouts are automatically additive or mutually complete.}
