...
\begin{itemize}
  ...
  branch forrásdeklarációtól effektív readout-idő sorrendig.  Rögzítenie kell
  \(\Rmap\) matematikai típusát, minimális esetben le kell vezetnie egy
  sajátidő- vagy readout-idő ismert limitet, és előre deklarálnia kell legalább
  egy kizárást, például same-source double counting tiltást.
