...
A következő verzióban a kért előrelépésnek szűkebbnek kell lennie, mint egy
újabb általános foundation-réteg.  Egyetlen worked branch a helyes cél:
observer-time, finite readout-time, vagy ehhez hasonlóan kicsi ág.  Ennek az
