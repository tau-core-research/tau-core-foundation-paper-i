...
Az \eqref{eq:obstruction-hu} egyenlet nem sötétanyag-képlet és nem
kvantum-kollapszus képlet.  Absztrakt hiányossági rekord.  Egy fizikai ágnak később meg kell
...
Az elfogadott visszaminősítési státuszok:
\[
  \texttt{toy-only},\qquad
  \texttt{phenomenological-only},\qquad
  \texttt{blocked},\qquad
  \texttt{rejected}.
\]
